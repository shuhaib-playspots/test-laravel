...
<div class="admin-shell">
    ...
    <aside class="sidebar">
        ...
        @php
            ...
            $inCareers     = request()->routeIs('admin.jobs.*');
            $inPosts       = request()->routeIs('admin.posts.*');
        @endphp
        <div class="sidebar-nav">
            ...
            {{-- Posts accordion --}}
            <div class="nav-group {{ $inPosts ? 'open' : '' }}" id="group-posts">
                <button type="button" class="nav-group-toggle" onclick="toggleGroup('group-posts')">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="nav-submenu">
                    <a href="{{ route('admin.posts.index') }}"
                       class="nav-sub-item {{ request()->routeIs('admin.posts.index') ? 'active' : '' }}">
                        All Posts
                    </a>
                    <a href="{{ route('admin.posts.create') }}"
                       class="nav-sub-item {{ request()->routeIs('admin.posts.create') ? 'active' : '' }}">
                        Upload Post
                    </a>
                </div>
            </div>
            ...
            {{-- Jobs accordion --}}
            <div class="nav-group {{ $inCareers ? 'open' : '' }}" id="group-jobs">
                <button type="button" class="nav-group-toggle" onclick="toggleGroup('group-jobs')">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="nav-submenu">
                    <a href="{{ route('admin.jobs.index') }}"
                       class="nav-sub-item {{ request()->routeIs('admin.jobs.index') || request()->routeIs('admin.jobs.edit') ? 'active' : '' }}">
                        All Listings
                    </a>
                    <a href="{{ route('admin.jobs.create') }}"
                       class="nav-sub-item {{ request()->routeIs('admin.jobs.create') ? 'active' : '' }}">
                        Add Listing
                    </a>
                    <a href="{{ route('admin.jobs.applications') }}"
                       class="nav-sub-item {{ request()->routeIs('admin.jobs.applications') ? 'active' : '' }}">
                        Applications
                    </a>
                </div>
            </div>
