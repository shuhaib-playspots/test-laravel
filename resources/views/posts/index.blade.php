...
@section('title', 'Posts &mdash; Nabaath Learning Point')
...
{{-- Hero --}}
<section class="hero" style="background: linear-gradient(135deg, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.65) 100%), url('{{ asset('images/gallery-cover.webp') }}') center/cover no-repeat;">
    ...
    <div class="hero-content">
        ...
        <h1 class="hero-title">
            Snapshots of <span class="accent">Every Day</span>
        </h1>
        <p class="hero-desc">
            A growing feed of moments, milestones, and memories from Nabaath Learning Point.
        </p>
        <div class="hero-breadcrumb">
            <a href="{{ route('home') }}">Home</a>
            <span class="sep">/</span>
            <span style="color:rgba(255,255,255,0.9);">Posts</span>
        </div>
    </div>
</section>
...
<section class="posts-section">
    ...
    @if($posts->isEmpty())
        <div class="empty-state">
            ...
            <p>Check back soon — we'll be sharing moments here regularly.</p>
        </div>
    @else
        <div class="posts-feed">
            @foreach($posts as $post)
                <article class="post-card">
                    ...
                    @if($post->caption || $post->created_at)
                        <div class="post-body">
                            @if($post->caption)
